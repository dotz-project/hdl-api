 ...
 */
class ComponentsController extends ActiveController
{
    public $modelClass = 'app\models\Components';
    ...
    public function checkAccess($action, $model = null, $params = []){
        if (!Yii::$app->user->can("api.components.{$action}") && !empty(yii::$app->user->id)) 
